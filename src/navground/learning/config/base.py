...
class ObservationConfig(abc.ABC, Registrable):
    ...
    and data generated by :py:class:`navground.sim.Sensor`.
    """
...
class StateConfig(abc.ABC, Registrable):
    """
    Configure how to get the environment state from the current state of
    a :py:class:`navground.sim.World`
    """
    ...
    def get_state(self, world: sim.World) -> Array:
        """
          ...
          :returns: an array with the global state
        """
        ...
